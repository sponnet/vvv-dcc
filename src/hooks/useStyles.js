...
const defaults = {
    ...
    '__relay_width'         : 25,
    '__relay_height'        : 25,
    '__relay_border_size'   : 1,
    '__relay_margin_vert'   : 5,
    '__relay_margin_horz'   : 4,
}
...
const setStyles = (totalSteps) => {
    ...
    setProperty('--relay-border-size', defaults.__relay_border_size + 'px')
    setProperty('--relay-width', defaults.__relay_width + 'px')
    setProperty('--relay-height', defaults.__relay_height + 'px')
    setProperty('--relay-margin-vert', defaults.__relay_margin_vert + 'px')
    setProperty('--relay-margin-horz', defaults.__relay_margin_horz + 'px')
